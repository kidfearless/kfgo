...
namespace SWB_CSS
{
	...
	public class M4A1 : WeaponBase
	{
		...
		public M4A1()
		{
			...
			ViewModel = "weapons/swb/css/m4a1/css_v_m4a1.vmdl";
			WorldModelPath = "weapons/swb/css/m4a1/css_w_m4a1.vmdl";
			Icon = "/swb_css/textures/ui/css_icon_m4a1.png";
			FOV = 60;
			ZoomFOV = 35;
			...
			this.AnimatedActions = new List<AnimatedAction>()
				{
					 new AnimatedAction()
					 {
